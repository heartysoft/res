...
namespace Res.Core.Storage
{
    ...
    public class QueueAllocation
    {
        ...
        public QueueAllocation(long allocationId, string queueId, string subscriberId, DateTime expiresAtUtc, long startMarker, long endMarker)
        {
        ...
        public bool MatchesQueueAndSubscriber(string queueId, string subscriberId)
        {
            return QueueId.Equals(queueId) && SubscriberId.Equals(subscriberId);
        }
        ...
        {
            return new QueueAllocation(AllocationId, QueueId, subscriberId, expiresAt, StartMarker, EndMarker);
        }
