...
-- =============================================
CREATE PROCEDURE [dbo].[FetchEventLinks]
...
BEGIN
	...
	begin 
		With 
			cte AS (
				SELECT TOP (@SuggestedCount) ew.TimeStamp as 'Timestamp', s.Context as 'Context'
	...
	SELECT EventId, StreamId, ContextName, Sequence, TimeStamp, EventType from EventWrappers WHERE
